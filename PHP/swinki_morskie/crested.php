...
<body>
   ...
   <main>
    ...
    <ol>
        ...
        <img src="crested.jpg" alt="Świnka morska rasy crusted">
        <?php
        $query2 = "SELECT DISTINCT s.data_ur, s.miot, r.rasy from swinki s JOIN rasy r on s.rasy_id = r.id WHERE r.id = 7";
